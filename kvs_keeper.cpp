...
int main(int args, char** argv){
  try{
    ...
    k.register_cht<2, bool, std::string >("put", pfi::lang::function<bool(bool,bool)>(&all_and)); //update
    k.register_cht<2, std::string >("get", pfi::lang::function<std::string(std::string,std::string)>(&pass<std::string >)); //analysis
    k.register_cht<2, bool >("del", pfi::lang::function<bool(bool,bool)>(&all_and)); //update
